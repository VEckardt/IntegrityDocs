 ...
 * the port.
 */
public class RelationshipJGoPort extends JGoPort {
     ...
     */
    private RelationshipJGoNode node;
     ...
     */
    public RelationshipJGoPort(RelationshipJGoNode node) {
        super();
        this.node = node;
        setSelectable(false);
        setDraggable(false);
     ...
     */
    public RelationshipJGoNode getNode() {
        return node;
    }
    ...
    public Point getLinkPointFromPoint(int x, int y, Point p) {
        ...
        RelationshipJGoNode node = getNode();
    ...
    /**
     * Two RelationshipJGoPort objects are equal if their parent nodes are
     * equal.
     */
    public boolean equals(Object obj) {
        return getNode().equals(((RelationshipJGoPort) obj).getNode());
    }
}
