...
/**
 * A self-loop in the entity relationship that represents a self relationship.
 */
public class RelationshipJGoSelfLoop extends RelationshipJGoLink {
     ...
     * @param label Name of the relationship field
     * @see WorkflowJGoFactory#createLink
     */
    public RelationshipJGoSelfLoop(RelationshipJGoNode node, String label) {
        // NOTE: toPort is a dummy.
        // It has to be different from the other port.
        super(node.getPort(), new JGoPort(), label);
        setResizable(false);
    }
