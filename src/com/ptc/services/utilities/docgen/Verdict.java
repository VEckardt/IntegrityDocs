 ...
 * @author veckardt
 */
public class Verdict extends IntegrityObject {

   public Verdict(WorkItem workitem) {
      super(workitem, Types.Verdict);
   }

   @Override
   public Element getXML(Document job, Element command) {
      // Add this object to the global resources hash
      ...
      cmdName.appendChild(job.createTextNode("createverdict"));
